...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      default='cat:cond-mat.mes-hall+OR+cat:cond-mat.mtrl-sci+OR+cat:physics.optics+OR+cat:quant-ph',
  ...
  parser.add_argument('--wait-time', type=float, default=ransleep, help='lets be gentle to arxiv API (in number of seconds)')
